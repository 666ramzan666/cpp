...
public:
    void move() const override { cout << "Велосипедист крутит педали" << endl; }
};
...
public:
    void play() const override { cout << "Воспроизведение звука..." << endl; }
};

class Video : public Media {
public:
    void play() const override { cout << "Воспроизведение видео..." << endl; }
};
...
public:
    void getInfo() const override { cout << "Физическая книга" << endl; }
};
...
public:
    void turnOn() const override { cout << "Заработала стиральная машина" << endl; }
};

class Refrigerator : public Appliance {
public:
    void turnOn() const override { cout << "Охлаждение в холодильнике" << endl; }
};
...
public:
    void play() const override { cout << "Играем в видео игру" << endl; }
};
